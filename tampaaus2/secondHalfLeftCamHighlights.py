...
input_file_path_stem = "D:\\TampaAus02\\LeftCam\\"
output_file_path_stem = "D:\\TampaAus02\\Highlights\\"
input_file_path = input_file_path_stem + "C0002.MP4"
...
for index, row in csv_file.iterrows():
	...
	start = negative_shift_timestamp(row['start'], "01:11:23")
	#start = row['start']
	end = negative_shift_timestamp(row['end'], "01:11:23")
	#end = row['end']
	name = row['name']
	os.system("ffmpeg -i {} -vcodec copy -ss {} -to {} {}{}.{}.lc.{}.MP4".format(input_file_path, start, end, output_file_path_stem, iterator_tag, string_iterator, name))
	iterator += 1